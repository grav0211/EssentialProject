...
class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageViewRetryAction_retriesImageLoad() {
        ...
        let view0 = sut.simulateFeedImageViewVisible(at: 0)
        let view1 = sut.simulateFeedImageViewVisible(at: 1)
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url], "Expected two images URL request for the visible views")
    ...
    func test_feedImageView_preloadsImageURLWhenNearVisible() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.url], "Expected first image URL request once first image is neart visible")
        
        sut.simulateFeedImageViewNearVisible(at: 1)
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url], "Expected second image URL request once second image is neart visible")
    }
